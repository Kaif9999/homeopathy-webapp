  ...
  return (
    <>
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground">
              Holistic homeopathic treatment for all types of skin conditions and allergies
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-emerald-400">Comprehensive Skin Care</h2>
              <p className="text-muted-foreground leading-relaxed">
                Our homeopathic approach treats skin conditions by addressing internal imbalances. 
                This helps achieve lasting results without harsh chemicals or side effects.
              </p>
              <ul className="space-y-4">
                <li className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-emerald-500" />
                  <span className="text-muted-foreground">Natural treatment methods</span>
                </li>
                <li className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-emerald-500" />
                ...
                <li className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-emerald-500" />
                  <span className="text-muted-foreground">Treats root cause</span>
                </li>
              </ul>
            </div>
            <div className="bg-zinc-900/50 backdrop-blur-sm border border-emerald-900/30 rounded-2xl p-8">
              <h3 className="text-2xl font-semibold mb-4 text-emerald-400">Homeopathic Advantage</h3>
              <p className="text-muted-foreground mb-6">
                Homeopathy offers gentle yet effective treatment for various skin conditions, 
                from acne to chronic conditions like psoriasis and eczema.
              </p>
      ...
      <section className="py-20 bg-background">
        <div className="container">
          <DiseaseConsultationForm diseaseName="Skin Disease" />
        </div>
      </section>
    </>
  )
